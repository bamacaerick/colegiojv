    ...
    <div class="row stats">
        ...
        <div class="col-12 col-lg-3">
             <div class="stats-personal text-center">
                ...
                <span>___</span>
                <p class="stats-margin">personnels</p>
            </div>
        </div>
        <div class="col-12 col-lg-3">
            <div class="stats-classes text-center">
                <p class="h1 m-0">109</p>
                <span>___</span>
                <p class="stats-margin">classes</p>
            </div>
        </div>
        <div class="col-12 col-lg-3">
            <div class="stats-abroad text-center">
                <p class=" h1 m-0">81%</p>
                <span>___</span>
                <p class="stats-margin">de nos élèves poursuivent leurs études à l’étranger</p>
            </div>
        </div>
    </div>
</main>
